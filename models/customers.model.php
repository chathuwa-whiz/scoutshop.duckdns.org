...
class ModelCustomers{
	...
	static public function mdlAddCustomer($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(name, idDocument, email, phone, address, birthdate, purchases, lastPurchase) VALUES (:name, :idDocument, :email, :phone, :address, :birthdate, 0, '2024-03-16')");
